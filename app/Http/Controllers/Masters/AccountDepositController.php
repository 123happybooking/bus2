...
class AccountDepositController extends Controller
{
    ...
    {
        $subAccounts = AccountSub::where("account_id", 131)->get();
        ...
        $account = Account::where("code", 131)->first();
        ...
        return view('masters.account-deposit.index', compact(
            'datas','periods','period_id','yearmonth','months','subAccounts','sub_account_id'
        ));
    }

                    ...
                    <form action="{{ route('masters.reservation-categories.update', $reservationCategory) }}" method="POST" id="categoryForm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control @error('vehicle_workload') is-invalid @enderror" 
                                       id="vehicle_workload" name="vehicle_workload" 
                                       value="{{ old('vehicle_workload', $reservationCategory->vehicle_workload) }}" 
                                       min="0" max="99.99" placeholder="1.00">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control @error('driver_workload') is-invalid @enderror" 
                                       id="driver_workload" name="driver_workload" 
                                       value="{{ old('driver_workload', $reservationCategory->driver_workload) }}" 
                                       min="0" max="99.99" placeholder="1.00">

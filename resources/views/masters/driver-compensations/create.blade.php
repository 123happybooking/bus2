        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm card-edit">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-plus-circle"></i> 新規報酬登録</h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.driver-compensations.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('bus_assignment_id') is-invalid @enderror" 
                                       id="bus_assignment_id" name="bus_assignment_id" value="{{ old('bus_assignment_id') }}" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('itinerary_id') is-invalid @enderror" 
                                       id="itinerary_id" name="itinerary_id" value="{{ old('itinerary_id') }}" min="0">
                                @error('itinerary_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('comp_id') is-invalid @enderror" 
                                    ...
                                    @foreach($compensationTypes as $type)
                                        <option value="{{ $type->id }}" {{ old('comp_id') == $type->id ? 'selected' : '' }}>
                                            {{ $type->comp_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('qty') is-invalid @enderror" 
                                       id="qty" name="qty" value="{{ old('qty') }}" required min="0">
                                @error('qty')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    金額: <strong id="amountDisplay">0</strong> 円
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('remark') is-invalid @enderror" 
                                          id="remark" name="remark" rows="3" maxlength="500">{{ old('remark') }}</textarea>
                                @error('remark')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

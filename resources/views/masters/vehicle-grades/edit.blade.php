    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('masters.vehicle-grades.update', $grade) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          maxlength="100" placeholder="例: 上級車">{{ old('description', $grade->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

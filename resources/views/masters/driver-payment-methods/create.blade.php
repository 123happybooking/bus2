        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm card-edit">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-plus-circle"></i> 新規支払方法登録</h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.driver-payment-methods.store') }}" method="POST">
                        @csrf

        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm card-edit">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-pencil-square"></i> 報酬種別編集</h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.driver-compensation-types.update', $compensationType) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('comp_name') is-invalid @enderror" 
                                       id="comp_name" name="comp_name" value="{{ old('comp_name', $compensationType->comp_name) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       id="display_order" name="display_order" value="{{ old('display_order', $compensationType->display_order) }}" 
                                       min="0">
                                @error('display_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input @error('is_active') is-invalid @enderror" 
                                           ...
                                           {{ old('is_active', $compensationType->is_active) ? 'checked' : '' }}>
